    ...
    <div className="bg-ocean-800/50 backdrop-blur rounded-lg shadow-lg border border-ocean-700/30 p-6 my-6">
      ...
      <div className="relative">
        ...
        >
          ...
          {/* Legend */}
          <g transform={`translate(${margin.left + chartWidth - 230}, ${margin.top - 15})`}>
            <rect width="12" height="12" fill="#34D399" rx="2" />
            <text x="20" y="10" fontSize="12" fill="#D1D5DB">Breathe Time</text>
            
            <rect y="20" width="12" height="12" fill="#3B82F6" rx="2" />
            <text x="20" y="30" fontSize="12" fill="#D1D5DB">Target Hold Time</text>
            
            <rect y="40" width="12" height="12" fill="#8B5CF6" rx="2" />
            <text x="20" y="50" fontSize="12" fill="#D1D5DB">Actual Hold Time</text>
          </g>
