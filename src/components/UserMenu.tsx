...
const UserMenu: React.FC = () => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 py-2 bg-ocean-800 border border-ocean-700 rounded-lg shadow-xl z-10">
          ...
          <Link 
            to="/settings"
            className="flex items-center gap-2 px-4 py-2 text-ocean-300 hover:bg-ocean-700 hover:text-ocean-100 w-full text-left text-sm"
